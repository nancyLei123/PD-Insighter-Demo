...
This is a compact, static version of PD Insighter for research review. It includes three representative trials and requires no Project Aria tools, MPS processing, or raw SLAM downloads.

![Half_hour full-session view](assets/half_hour_full_session.png)

![60minutes_1 full-session view](assets/60minutes1_full_session.png)
